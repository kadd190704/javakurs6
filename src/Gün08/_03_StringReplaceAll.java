...
public class _03_StringReplaceAll {
    public static void main(String[] args) {
     ...
     //ReplaceAll:replaca gibi çalışır.farkı kriter(regex) verilebiliyor
     //regex: regular expression/ düzenli ifade eder
     ...
     String text="Merhaba1 Dünya234";
        ...
        //a,b,n leri _ yap= Mer___1 Dü_y_234
